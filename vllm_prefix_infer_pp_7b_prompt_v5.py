...
lora_path = '/mnt/cfs/SPEECH/liuhuang1/workspace/llm_pp/pp_qwen1half_7b_chat_prompt_v5/qwen1half-7b-chat/v0-20240515-125651/checkpoint-410/'
merged_model_path = "/mnt/cfs/SPEECH/liuhuang1/workspace/llm_pp/merged"
...
if 1 >= step:
    ...
    merged_model.save_pretrained("/mnt/cfs/SPEECH/liuhuang1/workspace/llm_pp/merged", max_shard_size="2048MB", safe_serialization=True)
