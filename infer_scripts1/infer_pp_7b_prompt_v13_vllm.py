...
merged_model_path = "/mnt/cfs/SPEECH/liuhuang1/workspace/llm_pp/merged_v13_0_5b_ckt12630"
...
def __cmd():
  ...
  parser.add_argument(
      "--filename",
      type=str,
      default='infer_pp_0_5b_prompt_v13_ckt12630_all.txt',
      required=False,
