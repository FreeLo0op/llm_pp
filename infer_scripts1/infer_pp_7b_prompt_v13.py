...
lora_path = '/mnt/cfs/SPEECH/liuhuang1/workspace/llm_pp/pp_qwen1half_7b_chat_prompt_v10/qwen1half-7b-chat/v0-20240524-034854/checkpoint-1710/'
...
def label2text(text_path, polyphone_dict, test_dev=False):
  """
    Args:
...
def __cmd():
  ...
  parser.add_argument(
      "--filename",
      type=str,
      default='infer_pp_7b_prompt_v12_ckt1710.txt',
      required=False,
