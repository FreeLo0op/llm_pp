...
mode_path = '/mnt/cfs/NLP/hub_models/Qwen1.5-1.8B-Chat'
lora_path = '/mnt/cfs/SPEECH/liuhuang1/workspace/llm_pp/pp_qwen1half_1_8b_chat_prompt_v5/qwen1half-1_8b-chat/v0-20240516-064752/checkpoint-160/'
...
def __cmd():
  ...
  output_file = os.path.join(output_dir, "infer_pp_1.8b_prompt_v5_ckt160.txt")
