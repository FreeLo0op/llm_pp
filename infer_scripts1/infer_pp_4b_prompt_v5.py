...
lora_path = '/mnt/cfs/SPEECH/liuhuang1/workspace/llm_pp/pp_qwen1half_4b_chat_prompt_v5/qwen1half-4b-chat/v0-20240516-141224/checkpoint-160/'
...
def __cmd():
  ...
  output_file = os.path.join(output_dir, "infer_pp_4b_prompt_v5_ckt160.txt")
