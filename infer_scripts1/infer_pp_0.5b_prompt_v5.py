...
mode_path = '/mnt/cfs/NLP/hub_models/Qwen1.5-0.5B-Chat'
lora_path = '/mnt/cfs/SPEECH/liuhuang1/workspace/llm_pp/pp_qwen1half_0_5b_chat_prompt_v5/qwen1half-0_5b-chat/v0-20240516-141643/checkpoint-160/'
...
def __cmd():
  ...
  output_file = os.path.join(output_dir, "infer_pp_0.5b_prompt_v5_ckt160.txt")
