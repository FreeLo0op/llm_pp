...
lora_path = '/mnt/cfs/SPEECH/liuhuang1/workspace/llm_pp/pp_qwen1half_7b_chat_prompt_v10_test/qwen1half-7b-chat/v0-20240524-090852/checkpoint-6370/'
...
def label2text(text_path, polyphone_dict):
  ...
  for i in range(0, len(trans_lists), 2):
    ...
    data.append([sid, text_seq, trans_lists[i+1], text_seq])
  return data
...
def __cmd():
  ...
  parser.add_argument(
      "--filename",
      type=str,
      default='infer_pp_7b_prompt_v10_test_ckt6370.txt',
      required=False,
