...
lora_path = '/mnt/cfs/SPEECH/liuhuang1/workspace/llm_pp/pp_qwen1half_7b_chat_prompt_v8_data1/qwen1half-7b-chat/v0-20240522-131019/checkpoint-1000/'
...
def __cmd():
  ...
  output_file = os.path.join(output_dir, "infer_pp_7b_prompt_v8_data1_ckt1000.txt")
