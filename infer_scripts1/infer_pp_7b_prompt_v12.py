...
lora_path = '/mnt/cfs/SPEECH/liuhuang1/workspace/llm_pp/pp_qwen1half_7b_chat_prompt_v12/qwen1half-7b-chat/v0-20240528-121648/checkpoint-1860/'
...
def __cmd():
  ...
  parser.add_argument(
      "--filename",
      type=str,
      default='infer_pp_7b_prompt_v12_ckt1860.txt',
      required=False,
