...
lora_path = '/mnt/cfs/SPEECH/liuhuang1/workspace/llm_pp/pp_qwen1half_7b_chat_prompt_v9_data2_rmpoly/qwen1half-7b-chat/v0-20240523-123415/checkpoint-50/'
...
def __cmd():
  ...
  output_file = os.path.join(output_dir, "infer_pp_7b_prompt_v9_data2_rmpoly_ckt50.txt")
