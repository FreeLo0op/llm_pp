...
def text2json(text_path, polyphone_dict, en_polyphone_dict, output_dir='', data_version="v1"):
  ...
  train_data, _ = gen_json_data(trans_lists[:15000] + trans_lists[20000:], polyphone_dict, en_polyphone_dict)
  dev_data, truth_answer_dev_data = gen_json_data(trans_lists[15000:20000], polyphone_dict, en_polyphone_dict)
...
def __cmd():
  ...
  parser.add_argument(
      "--text_file",
      type=str,
      # data4.txt 000001-010000-en.txt
      default='data4.txt',
      required=False,
