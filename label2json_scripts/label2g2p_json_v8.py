...
def text2json(text_path, polyphone_dict, output_dir=''):
  ...
  """
  trans_lists = []
  train_output_file = os.path.join(output_dir, "g2p_train_prompt_v8_data1.json")
  dev_output_file = os.path.join(output_dir, "g2p_dev_prompt_v8_data1.json")
  truth_dev_v5_file = os.path.join(output_dir, "truth_dev_v8.txt")
