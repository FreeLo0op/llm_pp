...
def gen_json_data(trans_lists, polyphone_dict, split_text_numbers=80, test_dev=False):
  """Args:
...
def text2json(text_path, polyphone_dict, output_dir='', data_version="v1"):
  """ rename id
    Args:
...
def __cmd():
  ...
  text2json(text_file, polyphone_dict, output_dir, data_version)
