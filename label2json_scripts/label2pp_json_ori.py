...
def text2json(text_path, output_dir='', start_sid=0):
  ...
  """
  trans_lists = []
  train_output_file = os.path.join(output_dir, "pp_train_prompt_ori.json")
  dev_output_file = os.path.join(output_dir, "pp_dev_prompt_ori.json")
  sid = start_sid
