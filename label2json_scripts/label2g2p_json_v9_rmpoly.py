...
def gen_json_data(trans_lists, polyphone_dict, split_text_numbers=80):
  """Args:
  ...
  for i in range(0, len(trans_lists), 2):
    ...
    for question, answer in zip(question_list, answer_list):
      ...
      question = re.sub(r'([^a-zA-Z])\s+', r'\1', question) 
    ...
    valid_data += 1
  print(f"process {i} data. valid_data: {valid_data}")
...
def text2json(text_path, polyphone_dict, output_dir=''):
  ...
  """
  trans_lists = []
  train_output_file = os.path.join(output_dir, "g2p_train_prompt_v9_data2_rmpoly.json")
  dev_output_file = os.path.join(output_dir, "g2p_dev_prompt_v9_data2_rmpoly.json")
  truth_dev_v5_file = os.path.join(output_dir, "truth_dev_v9_rmpoly.txt")
