...
merged_model_path = "/mnt/cfs/SPEECH/liuhuang1/workspace/llm_pp/merged_v21_4b_ckt220"
...
def __cmd():
  ...
  parser.add_argument(
      "--text_file",
      type=str,
      default='000001-010000-text.txt',
      required=False,
  ...
  parser.add_argument(
      "--filename",
      type=str,
      default='infer_pp_7b_prompt_v21_ckt220_text_all.txt',
      required=False,
